  ...
  return (
    <>
      ...
      <div className="" style={{
        ...
        <footer className="text-white text-center text-lg-start bg-dark" style={{ flexGrow: 1, zIndex: 100 }}>
          {/* Grid container */}
                ...
                <div className="form-outline form-white mb-4">
                  <ul className="ps-0">
                    ...
                    {!isAuthenticated && (
                      <>
                        <li className="nav-item mb-2">
                          <Link to={"/users/auth/login"} className="nav-link">Login</Link>
                        </li>
                        <li className="nav-item mb-2">
                          <Link to={"/users/auth/register"} className="nav-link">Register</Link>
                        </li>
                      </>
                    )}
                  </ul>
